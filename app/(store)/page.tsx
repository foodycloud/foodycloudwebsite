    ...
    <article className="group overflow-hidden rounded-2xl border border-stone-200 bg-white card-hover flex flex-col h-full">
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-stone-100">
        {food.imageUrl ? (
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-amber-100 to-amber-200 flex flex-col items-center justify-center p-4">
            <span className="text-4xl mb-2">🍲</span>
            <span className="text-amber-900 font-medium text-center font-display">{food.name}</span>
          </div>
        )}
